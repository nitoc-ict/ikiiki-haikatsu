...
class RuleExplanation2_1Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        yesButton.setOnClickListener {
            val intent = Intent(this, GameVideo2_1Activity::class.java)
        ...
        noButton.setOnClickListener {
            val intent = Intent(this, GamePlay2_1Activity::class.java)
            startActivity(intent)
        }
    }
}
