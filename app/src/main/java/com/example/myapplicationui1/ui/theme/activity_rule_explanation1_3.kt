...
class RuleExplanation1_3Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        yesButton.setOnClickListener {
            val intent = Intent(this, GameVideo1_3Activity::class.java)
        ...
        noButton.setOnClickListener {
            val intent = Intent(this, GamePlay1_3Activity::class.java)
            startActivity(intent)
        }
    }
}
