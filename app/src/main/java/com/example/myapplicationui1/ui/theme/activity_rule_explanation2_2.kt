...
class RuleExplanation2_2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        yesButton.setOnClickListener {
            val intent = Intent(this, GameVideo2_2Activity::class.java)
        ...
        noButton.setOnClickListener {
            val intent = Intent(this, GamePlay2_2Activity::class.java)
            startActivity(intent)
        }
    }
}
